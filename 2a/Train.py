...
def main():
    ...
    while not stop_requested:
        ...
        proximity = client.get_proximity_distance()
        print(f"Proximity sensor distance: {proximity:.3f} meters")
        ...
        color_r,color_g,color_b = client.get_color_rgb()
        print(f"Color RGB raw values: ({color_r:.3f}, {color_g:.3f}, {color_b:.3f})")

        #  Read sensor data from simulator
        sensor_data = client.get_line_sensors()
